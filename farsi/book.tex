...
\newXeTeXintercharclass\@leftparen@charclass
\newXeTeXintercharclass\@rightparen@charclass
\XeTeXcharclass `\( \@leftparen@charclass
\XeTeXcharclass `\) \@rightparen@charclass
\XeTeXcharclass `\[ \@leftparen@charclass
\XeTeXcharclass `\] \@rightparen@charclass
\ifdim\the\XeTeXversion\XeTeXrevision\p@>0.99993\p@
  \chardef\@alloc@intercharclass@top=4095
\else
  \chardef\@alloc@intercharclass@top=255
\fi
\XeTeXinterchartoks \@alloc@intercharclass@top \bidi@digits@charclass = {\BeginSwitchDigitFont}
\XeTeXinterchartoks \bidi@digits@charclass \@alloc@intercharclass@top = {\EndSwitchDigitFont}
\XeTeXinterchartoks \@leftparen@charclass \bidi@digits@charclass = {\BeginSwitchDigitFont}
\XeTeXinterchartoks \bidi@digits@charclass \@rightparen@charclass = {\EndSwitchDigitFont}
...
\begin{latin}
%\begin{lstlisting}[title={Readers-writers initialization}]{}
\begin{lstlisting}[title={مقدار دهی اولیه خوانندگان-نویسندگان}]{}
...
\begin{lstlisting}[title={راه حل خوانندگان-نویسندگان (خواننده)}]{}
...
\begin{lstlisting}[title={مقدار دهی اولیه خوانندگان-نویسندگان بدون قحطی}]{}
...
\begin{lstlisting}[title={راه حل نویسنده بدون قحطی}]{}
turnstile.wait()
...
\begin{lstlisting}[title={راه حل خواننده بدون قطحی}]{}
turnstile.wait()
turnstile.signal()
...
\begin{lstlisting}[title={مقداردهی اولیه خوانندگان-نویسندگان با اولویت نویسنده}]{}
readSwitch = Lightswitch()
...
\begin{lstlisting}[title={راه حل خواننده با اولویت نویسنده}]{}
noReaders.wait()
...
\begin{lstlisting}[title={راه حل نویسنده با اولویت نویسنده}]{}
...
\begin{lstlisting}[title={حلقه میوتکس}]{}
while True:
    mutex.wait()
    # critical section 
    mutex.signal()
...
\begin{lstlisting}[title={راهنمایی میوتکس بدون قحطی}]{}
room1 = room2 = 0
mutex = Semaphore(1)
t1 = Semaphore(1)
t2 = Semaphore(0)
...
\begin{lstlisting}[title={الگوریتم  \lr{Morris}}]{}
mutex.wait()
