...
%to know which thread, if either, will continue immediately.
    ...
    هیچ راهی وجود ندارد که بدانیم کدام نخ بلافاصله ادامه می‌یابد. 
...
%and initializing it is
    در این کتاب از یک شبه زبان\LTRfootnote{pseudo-language} ساده به منظور نمایش نحوهٔ‌ عملکرد سمافورها استفاده می‌کنم. 
    نحو ایجاد یک سمافور و مقداردهی اولیه آن در ادامه آمده است. 
%
\begin{latin}
\begin{latin}
