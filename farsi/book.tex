...
\makeatletter
    ...
    \if@bidi@csundef{if@nonlatin}{%
        ...
        \newcommand*{\EndSwitchDigitFont}{\if@q@verbatim\else\if@Latin\else\currentfont \fi\fi}
    }{%
        \newcommand*{\BeginSwitchDigitFont}{\if@q@verbatim\else%
        \global\edef\currentfont{\the\font}\if@nonlatin\yasfont \fi\fi}
        \newcommand*{\EndSwitchDigitFont}{\if@q@verbatim\else\if@nonlatin\currentfont \fi\fi}
    }
