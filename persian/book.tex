...
%``I'll do it for you'' pattern?
    معمّا: آیا می‌توانید راه حلی برای این مساله با کمک الگوی ``بخاطر تو انجام خواهم داد'' بیابید؟
...
%waiting}, which is an example of the ``I'll do it for you'' pattern.
    زمانیکه تمامی مسافران سوار شدند، اتوبوس مقدار  {\tt waiting} را بروزرسانی می‌نماید که این مثالی از الگوی ``بخاطر تو انجام خواهم داد'' است. 
