...
\newcommand{\theversion}{Version 2.1.6}
...
\lstset{basicstyle=\tt, stepnumber=1, frame=tblr, 
backgroundcolor=lightgray, escapeinside={(*}{*)}}
...
%crispin.hawkins@googlemail.com
...
Note: this solution does not handle a signal when the queue is
empty.  I will leave it up to you to fix that.
...
\begin{lstlisting}[caption={Search-Insert-Delete hint}]{}
...
\begin{lstlisting}[caption={Search-Insert-Delete solution (searcher)}]{}
...
\begin{lstlisting}[caption={Search-Insert-Delete solution (inserter)}]{}
...
\begin{lstlisting}[caption={Search-Insert-Delete solution (deleter)}]{}
noSearcher.wait()
noInserter.wait()
# critical section
noInserter.signal()
...
\begin{lstlisting}[caption={Unisex bathroom hint}]{}
empty = Semaphore(1)
...
\begin{lstlisting}[caption={Unisex bathroom solution (female)}]{}
...
\begin{lstlisting}[caption={No-starve unisex bathroom solution (male)}]{}
turnstile.wait()
...
\begin{lstlisting}[caption={Sushi bar hint}]{}
eating = waiting = 0
mutex = Semaphore(1)
block = Semaphore(0)
must_wait = False
...
\begin{lstlisting}[caption={Sushi bar non-solution}]{}
mutex.wait()
if must_wait:
    waiting += 1
    mutex.signal()
...
\begin{lstlisting}[caption={Child care hint}]{}
...
\begin{lstlisting}[caption={Child care non-solution (adult)}]{}
multiplex.signal(3)
...
\begin{lstlisting}[caption={Child care solution (adult)}]{}
multiplex.signal(3)
...
\begin{lstlisting}[caption={Room party hint}]{}
students = 0                
dean = 'not here'           
mutex = Semaphore(1)
turn = Semaphore(1)
...
\begin{lstlisting}[caption={Faneuil Hall problem solution (spectator)}]{}
noJudge.wait()
enter()
noJudge.signal()
...
\begin{lstlisting}[caption={Dining Hall problem hint}]{}
eating = 0
readyToLeave = 0
mutex = Semaphore(1)
...
\begin{lstlisting}[caption={Dining Hall problem solution}]{}
getFood()
...
\begin{lstlisting}[caption={Extended Dining Hall problem hint}]{}
readyToEat = 0
eating = 0
readyToLeave = 0
mutex = Semaphore(1)
...
\begin{lstlisting}[caption={Extended Dining Hall problem solution}]{}
getFood()
...
%\begin{lstlisting}[caption={Party problem hint}]{}
%\end{lstlisting}

%\clearemptydoublepage
%\subsection {Party problem solution}

%\begin{lstlisting}[caption={Party problem solution}]{}
%\end{lstlisting}
